  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" data-toggle="modal" data-target="#modalContact"><span class="glyphicon glyphicon-envelope"></span> Contact</a></li>
      </ul>
     </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div class="modal fade" id="modalContact" tabindex="-1" role="dialog">
  ...
  <header class="text-center">
    <h1>XENON-IT | Notre société <img src="assets/images/speaking.svg" /></h1>
  </header>
  <div class="hidden-xs arrow-down"></div>
  <!-- main container -->
  ...
  <div class="container-fluid">
      ...
      <div class="col-sm-6 col-md-5">
       <h3>GEDK</h3>
          <div class="text-justify">
            ...
            <p>La gestion électronique de documents ou GED est un système informatisé qui permet la numérisation et l'archivage des documents de votre entreprise</p>
            <p>La gestion électronique de documents ou GED est un système informatisé qui permet la numérisation et l'archivage des documents de votre entreprise</p>
            <a href="#ged2" data-toggle="tab" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>En savoir plus</a>

            <button class="btn btn-info"><span class="glyphicon glyphicon-envelope"></span> Contact</button>
          </div>
      </div>
    </div> <!-- ged1-->
    ...
    <div class="tab-pane fade" id="ged2">
        ...
        <h3>GEDKKKKK</h3>
          <div class="text-justify">
            <p>La gestion électronique de documents ou GED est un système informatisé qui permet la numérisation et l'archivage des documents de votre entreprise</p>
             <a href="#ged1" data-toggle="tab" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>En savoir plus</a>
               <button class="btn btn-info"><span class="glyphicon glyphicon-envelope"></span> Contact</button>
          </div>
        </div>
      </div> <!-- ged2-->
      ...
      <h3>Dématérialisation</h3>
        <div class="text-justify">
            <p>Factures clients et fournisseurs, contrats, documents rh... notre plateforme de dématérialisation sécurisée permet de traiter, de manière intégrée, l'ensemble de vos flux entrants et sortants ainsi que leur archivage à vocation probatoire.</p>
              <a href="#demat2" data-toggle="tab" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>En savoir plus</a>
               <button class="btn btn-info"><span class="glyphicon glyphicon-envelope"></span> Contact</button>
        </div>
    </div> <!-- col -->
    </div> <!-- demat1 -->
    ...
    <div class="col-sm-6 col-md-pull-5 col-md-5">
      <h3>Dématérialisation 2</h3>
        <div class="text-justify">
            <p>Factures clients et fournisseurs, contrats, documents rh... notre plateforme de dématérialisation sécurisée permet de traiter, de manière intégrée, l'ensemble de vos flux entrants et sortants ainsi que leur archivage à vocation probatoire.</p>
             <p>Factures clients et fournisseurs, contrats, documents rh... notre plateforme de dématérialisation sécurisée permet de traiter, de manière intégrée, l'ensemble de vos flux entrants et sortants ainsi que leur archivage à vocation probatoire.</p>
              <a href="#demat1" data-toggle="tab" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>En savoir plus</a>
               <button class="btn btn-info"><span class="glyphicon glyphicon-envelope"></span> Contact</button>
        </div>
    </div> <!-- col -->
    </div> <!-- demat2 -->
